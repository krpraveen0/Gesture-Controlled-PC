 ...
 * praveen kumar
 * Website: www.electronicdunia.com
 */
...
{ 
  ...
  duration = pulseIn(echoPin1, HIGH, 3000);// here this pulsein function wont wait more then 5000us for the ultrasonic sound to came back. (due to this it wont measure more than 60cm)
